"""
Tools & Car Accessories Scraper - Complete Production Version
Scrapes https://www.sheeel.com/ar/tools-car-accessories.html with pagination
...
class ToolsCarAccessoriesScraper:
    def __init__(self, s3_bucket=None, aws_access_key=None, aws_secret_key=None):
        self.base_url = "https://www.sheeel.com/ar/tools-car-accessories.html"
        self.category = "tools_car_accessories"
        self.products = []
    ...
    def scrape_all_pages(self):
        ...
        print("\n" + "="*70)
        print("🚀 TOOLS & CAR ACCESSORIES SCRAPER - WITH PAGINATION")
        print("="*70)
        print(f"\nURL: {self.base_url}\n")
    ...
    def save_to_excel(self, include_s3_paths=False):
        ...
        filename = f"tools_car_accessories_{timestamp}.xlsx"
    ...
    def upload_results_to_s3(self):
        ...
        # Save locally
        timestamp = datetime.now().strftime("%Y%m%d_%H%M%S")
        excel_filename = f"tools_car_accessories_{timestamp}.xlsx"
    ...
    def run(self):
        ...
        print("\n" + "="*70)
        print("🔧 TOOLS & CAR ACCESSORIES SCRAPER - PRODUCTION")
        print("="*70)
...
if __name__ == "__main__":
    ...
    # Run scraper
    scraper = ToolsCarAccessoriesScraper(
        s3_bucket=s3_bucket,
