"""
Only On Sheeel Scraper - Optimized with Concurrent Subcategory Scraping
Scrapes https://www.sheeel.com/ar/only-on-sheeel.html and all subcategories
...
class OnlyOnSheeelScraper:
    def __init__(self, s3_bucket=None, aws_access_key=None, aws_secret_key=None, max_concurrent_subcategories=3):
        self.base_url = "https://www.sheeel.com/ar/only-on-sheeel.html"
        self.category = "only_on_sheeel"
    ...
    async def get_subcategories(self, page):
        ...
        try:
            ...
            for elem in subcategory_elements:
                ...
                if url and name and '/ar/only-on-sheeel/' in url:
    ...
    async def scrape_all_subcategories(self):
        ...
        print("\n" + "="*70)
        print("🚀 ONLY ON SHEEEL SCRAPER - CONCURRENT SUBCATEGORIES")
        print("="*70)
    ...
    def save_to_excel(self, include_s3_paths=False):
        ...
        filename = f"only_on_sheeel_{timestamp}.xlsx"
    ...
    def upload_results_to_s3(self):
        ...
        # Upload to S3
        timestamp = datetime.now().strftime("%Y%m%d_%H%M%S")
        excel_filename = f"only_on_sheeel_{timestamp}.xlsx"
    ...
    def run(self):
        ...
        print("\n" + "="*70)
        print("📱 ONLY ON SHEEEL SCRAPER - OPTIMIZED (CONCURRENT)")
        print("="*70)
