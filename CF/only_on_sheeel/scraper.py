"""
Only On Sheeel Scraper - Cloudflare R2 Version
...
class OnlyOnSheeelScraper:
    ...
    async def scrape_all_subcategories(self):
        ...
        print("\n" + "="*70)
        print("🚀 ONLY ON SHEEEL SCRAPER - CLOUDFLARE R2 / CONCURRENT SUBCATEGORIES")
        print("="*70)
    ...
    def run(self):
        ...
        print("\n" + "="*70)
        print("📱 ONLY ON SHEEEL SCRAPER - CLOUDFLARE R2 (CONCURRENT)")
        print("="*70)
