"""
Eid Offers Scraper - Cloudflare R2 Version
Scrapes https://www.sheeel.com/ar/ramadan-2025.html and all subcategories
...
class EidOffersScraper:
    def __init__(self, r2_bucket=None, cf_access_key=None, cf_secret_key=None, cf_endpoint_url=None, max_concurrent_subcategories=3):
        self.base_url = "https://www.sheeel.com/ar/ramadan-2025.html"
        self.category = "eid_offers"
    ...
    async def get_subcategories(self, page):
        ...
        try:
            ...
            for elem in subcategory_elements:
                ...
                if url and name and '/ar/ramadan-2025/' in url:
    ...
    async def scrape_all_subcategories(self):
        ...
        print("\n" + "="*70)
        print("🚀 EID OFFERS SCRAPER - CLOUDFLARE R2 / CONCURRENT SUBCATEGORIES")
        print("="*70)
    ...
    def save_to_excel(self, include_r2_paths=False):
        ...
        filename = f"eid_offers_{timestamp}.xlsx"
    ...
    def upload_results_to_r2(self):
        ...
        timestamp = datetime.now().strftime("%Y%m%d_%H%M%S")
        excel_filename = f"eid_offers_{timestamp}.xlsx"
    ...
    def run(self):
        ...
        print("\n" + "="*70)
        print("📱 EID OFFERS SCRAPER - CLOUDFLARE R2 (CONCURRENT)")
        print("="*70)
